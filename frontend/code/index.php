<?php
echo "<h1> This is the Three Tier Architecture Test New Mytest -- MY NEW CODE</h1>";
echo "<h3> Your Web Running Apache with php on Frontend container -- BUILD_SHIP_RUN </h3>";
